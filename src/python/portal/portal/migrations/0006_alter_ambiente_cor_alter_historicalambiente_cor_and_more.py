...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='papel',
            field=models.CharField(choices=[('student', 'Aluno'), ('editingteacher', 'Professor'), ('teacher', 'Tutor'), ('manager', 'Coordenador'), ('coursecreator', 'Conteudista')], max_length=256, verbose_name='papel'),
        ),
        migrations.AlterField(
