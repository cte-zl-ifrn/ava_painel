    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sigla', models.CharField(max_length=255, unique=True, verbose_name='sigla do ambiente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator(re.compile('(\\d{5}\\.\\d\\.\\d{5}\\...)\\.(.*\\..*)'))], verbose_name='código do diário')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator(re.compile('(\\d{5})\\.(\\d)\\.(\\d{5})\\.(..)'))], verbose_name='código da turma')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='portal.polo')),
