...
mock_diarios_all = [
            ...
            },
            {
                ...
                "diario": { 
                    ...
                    "codigo": "20202.1.15047.2E.POS.0004", 
                    "progresso": 30,
                    "thumbnail": "https://blogdoenem.com.br/wp-content/uploads/2019/02/Reda%C3%A7%C3%A3o-par%C3%A1grafos-d.jpg", 
                    "url": "https://google.com", 
                }
            },
            {
                ...
                "diario": { 
                    ...
                    "codigo": "20202.1.15047.2E.POS.0005", 
                    "progresso": 100,
            ...
            },
            {
                ...
                "diario": { 
                    ...
                    "codigo": "20202.1.15047.1E.POS.0006", 
                    "progresso": 30,
            ...
            },
            {
                ...
                "diario": { 
                    ...
                    "codigo": "20202.1.15047.1E.POS.0007", 
                    "progresso": 30,
            ...
            },
            {
                ...
                "diario": { 
                    "titulo": "Lógica de programação", 
                    "codigo": "20202.1.15047.2E.POS.0007", 
                    "progresso": 30,
...
@api.get("/diarios/")
def diarios(request):
    mock_diarios = [x for x in mock_diarios_all if competencia(x['diario']['codigo']) == request.GET.get('competencia_id', mock_competencias[0]['id'])]
    
    if request.GET.get('disciplina_id', None):
        mock_diarios_filtrado = [x for x in mock_diarios if x['diario']['codigo'].endswith(request.GET['disciplina_id'])]
    else:
        mock_diarios_filtrado = mock_diarios
